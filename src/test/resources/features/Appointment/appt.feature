@regression @appt
Feature: Appointment - User make appointment to hospital

  As User
  I want book appointment to org
  ...
  Scenario Outline: make appointment for <description>
    ...
    And I make an appointment to org name is "BV_THAI_AN"
      | appointmentType   | onDate   | specialtyCode   | reasonExamination   | notes   | bloodVessel   | bodyTemperature   | systolic   | diastolic   | capillary   | immuGdr   | addressExamination   | homeMedicalServiceType   | contactPhone   | companyName | companyAddress | companyTax |
      | <appointmentType> | <onDate> | <specialtyCode> | <reasonExamination> | <notes> | <bloodVessel> | <bodyTemperature> | <systolic> | <diastolic> | <capillary> | <immuGdr> | <addressExamination> | <homeMedicalServiceType> | <contactPhone> | GlobeDr     | 5B Phổ Quang   | 75315980   |
  ...
  #  insurance card and identity card to verify patient information for appointment
    ...
    Examples:
      ...
      | user_1  | Immunization Examination                        | ImmunizationExamination | Immunization             | Chủng ngừa           | tomorrow |               |                   |       |             |                 |          |           |           | false   |                    |                        | 0867891234   | presDocUrls    | []                                  | capillaryDocUrls    | []                                  | immuDocUrls[0] | data/image/immunization/immu-01.jpg | idCardDocUrls[0] | data/image/immunization/immu-01.jpg | insuDocUrls[0] | data/image/immunization/immu-01.jpg |
      | user_1  | ReExamination                                   | ReExamination           | ReExamination            | Tái khám             | tomorrow | 01            |                   |       |             |                 |          |           |           |         |                    |                        | 0867891234   | presDocUrls    | []                                  | capillaryDocUrls    | []                                  | immuDocUrls    | []                                  | idCardDocUrls[0] | data/image/immunization/immu-01.jpg | insuDocUrls[0] | data/image/immunization/immu-01.jpg |
      | user_1  | Physical Examination of Others                  | PhysicalExamination     | Physical Examination     | Khám sức khỏe        | tomorrow |               | 255               |       |             |                 |          |           |           |         |                    |                        | 0867891234   | presDocUrls    | []                                  | capillaryDocUrls    | []                                  | immuDocUrls    | []                                  | idCardDocUrls[0] | data/image/immunization/immu-01.jpg | insuDocUrls[0] | data/image/immunization/immu-01.jpg |
      | user_1  | Physical Examination of Go To Work              | PhysicalExamination     | Physical Examination     | Khám sức khỏe        | tomorrow |               | 1                 |       |             |                 |          |           |           |         |                    |                        | 0867891234   | presDocUrls    | []                                  | capillaryDocUrls    | []                                  | immuDocUrls    | []                                  | idCardDocUrls[0] | data/image/immunization/immu-01.jpg | insuDocUrls[0] | data/image/immunization/immu-01.jpg |
      | user_1  | Physical Examination of Register Driver License | PhysicalExamination     | Physical Examination     | Khám sức khỏe        | tomorrow |               | 2                 |       |             |                 |          |           |           |         |                    |                        | 0867891234   | presDocUrls    | []                                  | capillaryDocUrls    | []                                  | immuDocUrls    | []                                  | idCardDocUrls[0] | data/image/immunization/immu-01.jpg | insuDocUrls[0] | data/image/immunization/immu-01.jpg |
      | user_1  | Physical Examination of Business Contract       | PhysicalExamination     | Physical Examination     | Khám sức khỏe        | tomorrow |               | 3                 |       |             |                 |          |           |           |         |                    |                        | 0867891234   | presDocUrls    | []                                  | capillaryDocUrls    | []                                  | immuDocUrls    | []                                  | idCardDocUrls[0] | data/image/immunization/immu-01.jpg | insuDocUrls[0] | data/image/immunization/immu-01.jpg |
