...
public class OrgVoucherDAO implements IDAO<Wallet, Boolean, Integer> {
    @Override
    public SqlDB getDB() {
    ...
    public Boolean deleteByOrgId(Integer orgId) {
        ...
        String cmd = String.format("delete from orgVoucher where orgId = %d", orgId);
    ...
    public Boolean deleteByVoucherName(String name) {
        ...
        String cmd = String.format(
                "delete from orgVoucher where voucherId " +
