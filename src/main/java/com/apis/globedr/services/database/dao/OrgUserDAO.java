...
public class OrgUserDAO implements IDAO<Org, Boolean, String> {
    @Override
    public SqlDB getDB() {
    ...
    public Boolean deleteByOrgId(Integer orgId) {
        String sql = String.format("delete from %s where orgId=%d", Table.ORG_USER,orgId);
    ...
    public Boolean deleteByUserId(Integer userId) {
        String sql = String.format("delete from %s where userId = %s", Table.ORG_USER, userId);
