...
public class OrgSpecialtyDAO implements IDAO<Org, Boolean, String> {
    @Override
    public SqlDB getDB() {
    ...
    public Boolean deleteByOrgId(Integer orgId) {
        String sql =  String.format("delete from %s where organizationId = %d", Table.ORG_SPECIALTY, orgId);
